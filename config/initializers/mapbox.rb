...
# browser's MapLibre can fetch raster tiles. The sidecar uses NAIP, not Mapbox,
# so it needs no Mapbox credential. Treat the public token accordingly (it is a
# pk.* token scoped to tile reads, not a secret).
